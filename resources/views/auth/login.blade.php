                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="demo-account">
                                ...
                                <button class="btn btn-sm btn-outline-primary w-100" onclick="fillDemo('admin@gmail.com', 'password')">
                                    Use Admin Demo
                                </button>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="demo-account">
                                ...
                                <p class="mb-1"><strong>Email:</strong> testing@gmail.com</p>
                                <p class="mb-2"><strong>Password:</strong> password</p>
                                <button class="btn btn-sm btn-outline-success w-100" onclick="fillDemo('testing@gmail.com', 'password')">
                                    Use User Demo
                                </button>
                            </div>
                        </div>
